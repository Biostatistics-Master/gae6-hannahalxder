...
The emmeans package [@emmeans] was used to calculate planned and unplanned comparisons and test for differences between injected and un-injected aphids, infected and uninfected aphids, and all pairwise comparisons of means.
...
aphidCont <- tidy(contrast(
  ...
  method = list(
    #                                   Un-inj   Un-inf   INF
    'Control vs Uninfected & Infected' = c(2,     -1,     -1),
...
Based on Table 3, there was no significant difference found between the hues of control and uninfected aphids. 
